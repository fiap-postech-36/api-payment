...
class CustomExceptionHandlerTest {
    ...
    @Test
    void testOrderStatusControlNotFoundException() {
        OrderStatusControlNotFoundException ex = new OrderStatusControlNotFoundException("Payment not found");

        ResponseEntity<Object> response = customExceptionHandler.orderStatusControlNotFoundException(ex, request);
